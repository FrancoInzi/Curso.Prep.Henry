...
function elevarAlCubo(num) {
  ...
  // Tu código:
  var nuevapotencias = num ** 3;
   return nuevapotencias;
}

function elevar(num, exponent) {
  // Devuelve el valor de "num" elevado al exponente dado en "exponent"
  // Tu código:
  var rta = num ** exponent;
  return rta;
}
...
function combinarNombres(nombre, apellido) {
  ...
  // Tu código:
  const editores = nombre + apellido;
  editores.split [' '[nombre, apellido]];
  return editores;
}
